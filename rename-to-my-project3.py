...
20.6.2014 - Converted to python3 via 2to3 (+1 post-fix), added original .py to ignore list
...
if sys.version_info[0] < 3:
    print(os.path.basename(__file__) +" requires Python version 3 and up")
    sys.exit(1)
...
def get_files(path,
              ignored_dirs=['.git'],
              ignored_files=[SCRIPT_NAME,'rename-to-my-project.py'],
